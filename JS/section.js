...
document.getElementById("money_id").addEventListener("click", function(){
    section_change("add_Money", "block");
section_change("cash_Out", "none");
section_change("transfer_Money", "none");
section_change("get_Bonus", "none");
...
document.getElementById("cashOut_id").addEventListener("click", function(){
...
document.getElementById("transfer_id").addEventListener("click", function(){
    section_change("add_Money", "none");
section_change("cash_Out", "none");
...
document.getElementById("bonus_id").addEventListener("click", function(){
    section_change("add_Money", "none");
section_change("cash_Out", "none");
section_change("transfer_Money", "none");
...
document.getElementById("pay_id").addEventListener("click", function(){
    section_change("add_Money", "none");
    section_change("cash_Out", "none");
    section_change("transfer_Money", "none");
    section_change("get_Bonus", "none");
